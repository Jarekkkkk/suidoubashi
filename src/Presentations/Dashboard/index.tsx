          ...
          <div className={styles.sectionContent}>
            ...
            >
              ...
              <span className={styles.contentText}>
                SuiDouBashi, a cutting-edge DeFi ecosystem that seamlessly
                blends Automated Market Making (AMM), Vesting, and Voting
                features.Whether you're a small or large player, SuiDouBashi
                offers liquidity, growth, and a delightful DeFi experience.
              </span>
            </div>
            <div className={styles.contentBlock}>
              ...
              <div className={styles.block}>
                ...
                <span className={styles.contentText}>
                  SuiDouBashi's Vesting allows players to lockup SDB Coin in
                  exchange for Bonding NFT
                </span>
              </div>
              <div className={styles.block}>
                <span className={styles.contentTitle}>AMM Dex</span>
                <span className={styles.contentText}>
                  SuiDouBashi's AMM provides automated market maker
                  functionality, ensuring liquidity for users to trade tokens
                  with lower fees and deep slippage
                </span>
              </div>
              <div className={styles.block}>
                ...
                <span className={styles.contentText}>
                  ...
                  governance. The voting feature is seamlessly integrated into
                  the AMM model, allowing SDB to gain value from external bribes
                  and pool fees.
                </span>
              </div>
              <div className={styles.block}>
                ...
                <span className={styles.contentText}>
                  SuiDouBashi introduce Gaming features like levels and
                  experience points as a loyalty program. Users can earn
            ...
            <div className={styles.contentBlock}>
              ...
              <div className={styles.block}>
                <div className={styles.contentTitle}>SDB</div>
                <div className={styles.contentText}>
                  SDB is used for rewarding liquidity providers through weekly
                  emissions provided by SuiDouBashi. Any SDB holders can obtain
                  NFT by vesting SDB.
                </div>
              </div>
              <div className={styles.block}>
                <div className={styles.contentTitle}>VeSDB</div>
                <div className={styles.contentText}>
